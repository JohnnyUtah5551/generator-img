...
async def buy(update: Update, context: ContextTypes.DEFAULT_TYPE):
    keyboard = [
        [InlineKeyboardButton("10 генераций - 1⭐", callback_data="buy_10")],
        [InlineKeyboardButton("50 генераций - 5⭐", callback_data="buy_50")],
        [InlineKeyboardButton("100 генераций - 10⭐", callback_data="buy_100")],
    ]
    await update.message.reply_text(
...
async def buy_button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "buy_10":
        prices = [LabeledPrice("10 генераций", 100)]
        amount = 10
    elif query.data == "buy_50":
        prices = [LabeledPrice("50 генераций", 500)]
        amount = 50
    else:
        prices = [LabeledPrice("100 генераций", 1000)]
        amount = 100
